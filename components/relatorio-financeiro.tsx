              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <Card>
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>
                      {((totalPago / totalDespesas) * 100).toFixed(1)}% do total
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>
                      {((totalPendente / totalDespesas) * 100).toFixed(1)}% do total
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex justify-between items-center">
                        ...
                        <Popover>
                          ...
                          <PopoverContent className="w-80">
                            <p className="text-sm">
                              Estimativa de quantos meses seriam necessários para pagar toda a dívida atual,
                              baseado na média mensal de pagamentos.
                            </p>
                          </PopoverContent>
                        </Popover>
                      </div>
                      <div className="text-2xl font-bold mt-2">{racios.mesesParaLiquidarDivida.toFixed(1)}</div>
                      <div className={`text-sm ${racios.mesesParaLiquidarDivida <= 6 ? "text-green-600" : racios.mesesParaLiquidarDivida <= 12 ? "text-amber-600" : "text-red-600"}`}>
                        {racios.mesesParaLiquidarDivida <= 6 ? "Excelente" : racios.mesesParaLiquidarDivida <= 12 ? "Aceitável" : "Preocupante"}
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex justify-between items-center">
                        ...
                        <Popover>
                          ...
                          <PopoverContent className="w-80">
                            <p className="text-sm">
                              Percentual de pagamentos que estão atualmente em atraso.
                              Um valor baixo indica boa gestão de pagamentos.
                            </p>
                          </PopoverContent>
                        </Popover>
                      </div>
                      <div className="text-2xl font-bold mt-2">{racios.percentualAtraso.toFixed(1)}%</div>
                      <div className={`text-sm ${racios.percentualAtraso <= 5 ? "text-green-600" : racios.percentualAtraso <= 15 ? "text-amber-600" : "text-red-600"}`}>
                        {racios.percentualAtraso <= 5 ? "Excelente" : racios.percentualAtraso <= 15 ? "Aceitável" : "Preocupante"}
                      </div>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="h-[400px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={despesasPorMes} margin={{ left: 20, right: 20 }}>
                        ...
                        />
                        <Legend />
                        <Line type="monotone" dataKey="valor" name="Total de Despesas" stroke="#8884d8" strokeWidth={2} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                      Ideal: &gt; 1.0 (quanto maior, melhor)
                    </p>
                    <p className={`text-sm font-medium ${racios.racioLiquidez >= 1.5 ? "text-green-600" : racios.racioLiquidez >= 1 ? "text-yellow-600" : "text-red-600"}`}>
                      {racios.racioLiquidez >= 1.5 ? "Excelente" : racios.racioLiquidez >= 1 ? "Adequado" : "Insuficiente"}
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    />
                    <p className="mt-2 text-sm text-gray-600">
                      Ideal: 0 ou negativo (pagamento antes do vencimento)
                    </p>
